                    ...
                    <div class="col-xl-6">
                        <div class="d-flex align-items-center login">
                            ...
                            <div class="register">
                                ...
                                </i><a href="backend/dashboard/">Go to Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="gap">
        <div class="container">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="featured-dishes">
                            <div class="featured-dishes-img">
                                <img alt="featured-dishes" src="public/images/products/<?= $product['image'] ?>" width="100%" height="100%">
                            </div>
                            <ul class="star">
                            ...
                            <a href="javascript:;" onclick="add_to_cart(<?= $product['id'] ?>)" class="theme-bg-clr">
                                <i>
                                    <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <path d="m452 120h-60.946c-7.945-67.478-65.477-120-135.054-120s-127.109 52.522-135.054 120h-60.946c-11.046 0-20 8.954-20 20v352c0 11.046 8.954 20 20 20h392c11.046 0 20-8.954 20-20v-352c0-11.046-8.954-20-20-20zm-196-80c47.484 0 87.019 34.655 94.659 80h-189.318c7.64-45.345 47.175-80 94.659-80zm176 432h-352v-312h40v60c0 11.046 8.954 20 20 20s20-8.954 20-20v-60h192v60c0 11.046 8.954 20 20 20s20-8.954 20-20v-60h40z"></path>
            ...
            <ul class="pagination m-auto mt-5">
                <li class="prev">
                    <?php if ($page > 1) : ?>
                        <a href="index.php?page=<?= $prev ?>"><i class="fa-solid fa-angles-left"></i></a>
                    <?php else : ?>
                        <a href="javascript:;"><i class="fa-solid fa-angles-left"></i></a>
                    <?php endif; ?>
                </li>
                ...
                <li class="next">
                    <?php if ($page < $pages) : ?>
                        <a href="index.php?page=<?= $next ?>"><i class="fa-solid fa-angles-right"></i></a>
                    <?php else : ?>
                        <a href="javascript:;"><i class="fa-solid fa-angles-right"></i></a>
                    <?php endif; ?>
                </li>
            </ul>
        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        toastr.error('Produk gagal ditambahkan ke keranjang', 'Error');
                    }
                }
            });
        }
