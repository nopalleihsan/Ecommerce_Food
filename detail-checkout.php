            ...
            <form class="woocommerce-cart-form">
                <div style="overflow-x:auto;overflow-y: hidden;">
                    <table class="shop_table table-responsive">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT order_items.*, products.name, products.image, products.price FROM order_items JOIN products ON order_items.product_id = products.id WHERE order_items.order_id = $id";
                            $query = $con->prepare($sql);
                            $query->execute();
                            ...
                            ?>
                                <tr>
                                    <td class="product-name">
                                        <img alt="img" src="public/images/products/<?= $item['image'] ?>" class="img-fluid" width="100">
                                        <div>
                                            <a href="#"><?= $item['name'] ?></a>
                                    ...
                                    <td class="product-quantity">
                                        <input type="number" class="input-text" value="<?= $item['quantity'] ?>">
                                    </td>
                                    <td class="product-subtotal">
                                        <span class="woocommerce-Price-amount"><bdi><span class="woocommerce-Price-currencySymbol">Rp. </span><?= number_format($item['quantity'] * $item['price'], 0, ',', '.') ?></bdi></span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
