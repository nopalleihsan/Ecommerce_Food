                        ...
                        <form id="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="harga" name="price" type="text" placeholder="Harga" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (stok)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="stok" name="stock" type="text" placeholder="Stok" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="description" type="text" placeholder="Deskripsi"></textarea>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
