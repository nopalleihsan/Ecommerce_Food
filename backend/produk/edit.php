                        ...
                        <form id="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="nama" name="name" type="text" placeholder="Nama" value="<?= $produk['name'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (harga)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="harga" name="price" type="text" placeholder="Harga" value="<?= $produk['price'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (stok)-->
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="stok" name="stock" type="text" placeholder="Stok" value="<?= $produk['stock'] ?>" />
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="deskripsi" name="description" type="text" placeholder="Deskripsi"><?= $produk['description'] ?></textarea>
                                </div>
                            </div>
                            <div class="row gx-3 mb-3">
                                <!-- Form Group (categori_id)-->
                                <div class="col-md-12">
                                    <label class="small mb-1" for="category_id">Kategori</label>
                                    <select class="form-control" id="category_id" name="category_id">
                                        <option value="">Pilih Kategori</option>
                                        <?php foreach ($result as $row) { ?>
                                            <option value="<?php echo $row['id'] ?>" <?php if ($produk['category_id'] == $row['id']) {
                                                                                            echo "selected";
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="gambar" name="image" type="file" placeholder="Gambar" />
                                </div>
                            </div>
