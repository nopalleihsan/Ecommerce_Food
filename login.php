                                    ...
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center position-relative">
                                            ...
                                            <div class="p-img light-bg">
                                                ...
                                                <img src="public/frontend/img/product-img-1.png" alt="Product Image">
                ...
                <div class="col-lg-6">
                    <div class="box login">
                        ...
                        <form>
                            ...
                            <a href="index.php" class="button mt-4">Login</a>
                        </form>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="box register">
                        <div class="parallax" style="background-image: url(public/frontend/img/patron.jpg)"></div>
                        <h3>Log In Your Account</h3>
                        <form>
                            ...
                            <a href="index.php" class="button mt-4">Register</a>
                        </form>
                    </div>
                </div>
            </div>
